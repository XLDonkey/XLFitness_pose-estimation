...
3. **Go to:** `https://xldonkey.github.io/gym-ai-pose/kiosk.html`
...
## URL
`https://xldonkey.github.io/gym-ai-pose/kiosk.html`

For stakeholder demo (two-panel with NN brain visible):
`https://xldonkey.github.io/gym-ai-pose/tablet.html`
